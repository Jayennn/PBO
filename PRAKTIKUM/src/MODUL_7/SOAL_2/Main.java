...
public class Main {
  ...
  public static void main(String[] args) {
    Biodata biodata = new Biodata("John Doe", "A11.2018.11111", "Computer Science", "Faculty of Computer Science", "Universitas Brawijaya", "Jl. Veteran No. 1", "jhondoe@gmail.com", "Software Engineer", "Ngoding", "Java, Python, Javascript", "Dicoding Certificate");
